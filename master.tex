...
{\fontsize{12}{14}\selectfont
    \include{Sections/Lexer}
    \include{Sections/Parser}
    \include{Sections/TypeChecker}
	\include{Sections/CodeGen/CodeGen}
	\include{Sections/Interpreter}
	\include{Sections/Optimization/Optimization}
\end{document}
